...
export default function Footer({ className }: ComponentProps) {
  return (
    <footer className="relative flex flex-col items-start justify-between w-full min-h-screen bg-white overflow-hidden">
      {/* Header */}
          ...
          <li className="flex flex-col items-start justify-between flex-grow h-auto gap-y-[5vw] sm:gap-y-[1vw]">
            ...
            <div className="relative flex flex-col gap-y-[5vw] sm:gap-y-0">
              <a
                ...
                className="bottom-0 flex flex-row items-center group hover:font-bold duration-100 medium-text"
