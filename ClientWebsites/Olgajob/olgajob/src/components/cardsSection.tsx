...
export default function CardsSection() {
  return (
    <section id="iconCards" className="flex">
      {/* Desktop */}
      <div className="hidden sm:flex w-full p-12 h-[175vh]">
        <div className="flex flex-row justify-between gap-8 w-full">
          ...
          <div
            id="class_list"
            className="flex flex-col items-start justify-end overflow-clip gap-6 lg:mr-[10vw]"
          >
      ...
      {/* Mobile */}
      <div className="flex sm:hidden w-full p-12">
        <div className="flex flex-col justify-between gap-12 w-full">
          ...
          <div className={`relative h-[${cards.length}00vh] -mx-12`}>
            <div
              id="horizontalScroll"
              className="flex flex-col justify-start sticky top-0 pt-[72px] pb-12 h-[100vh] mx-12 z-10 gap-2"
            >
            ...
            <div
              id="horizontalScroll"
              className="flex overflow-clip -mx-12 -mt-[100vh] px-12 w-[100vw]"
            >
              <HorizontalScroll>
                {cards.map((card, index) => {
                  return (
          ...
          {/* <HorizontalScroll
            height="50vh"
            innerClassName="-mx-12 flex items-center overflow-hidden h-[50vh] bg-red-500"
          >
            {cards.map((card, index) => {
              return (
                <div className="flex flex-row items-center justify-between gap-4 lg:gap-12 border border-black px-4 py-2 h-full ml-12 mr-20">
                  <div className="cards__content flex flex-col gap-1 lg:gap-2">
                    <div className="text-[20px]">
                      <div className="block text-start relative">
                        {card.title}
