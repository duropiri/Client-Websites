...
function footer() {
  return (
    <footer
      no-fade=""
      this-theme="footer-mob"
      className="section"
      style={{ "--logo-height": "213.266px", "--multiplier": 1 } as React.CSSProperties}
    >
      <div className="container">
        <div className="footer">
          <div className="flex justify-between">
            <div id="w-node-_13ca7f54-c01b-761c-a9a4-eecf1f2d2a91-1f2d2a8d" className="flex flex-col space-y-4">
              <a href="/" aria-current="page" className="footer__item w-inline-block w--current">
                <div className="footer__item--text">
                  <div className="text-lg font-semibold">Home</div>
                </div>
              </a>
              <a href="/solutions" className="footer__item w-inline-block">
                <div className="footer__item--text">
                  <div className="text-lg font-semibold">Solutions</div>
                </div>
              </a>
              <a href="/about" className="footer__item w-inline-block">
                <div className="footer__item--text">
                  <div className="text-lg font-semibold">About</div>
                </div>
              </a>
              <a href="/team" className="footer__item w-inline-block">
                <div className="footer__item--text">
            ...
            <div
              id="w-node-_13ca7f54-c01b-761c-a9a4-eecf1f2d2aa1-1f2d2a8d"
              className="footer__form--parent w-form"
            >
              <form
                id="form"
                name="email-form"
                ...
                data-wf-flow="65d6917a6810372dfbc05427"
                data-wf-page-id="65d6917a6810372dfbc053fc"
                data-wf-element-id="13ca7f54-c01b-761c-a9a4-eecf1f2d2aa2"
                aria-label="Email Form"
              >
                <div className="footer__form--title">
                  <div
                    className="text-xl animating"
                    style={{ "--x": "0%", opacity: 1 } as React.CSSProperties}
                  >
                ...
                <div
                  className="flex animating"
                  style={{ "--x": "0%", opacity: 1 } as React.CSSProperties}
                >
                  <div className="footer__form--item">
                    <input
                      className="footer__form--input w-input"
                      name="email"
                      data-name="email"
                  ...
                  <div className="footer__form--btn prevent">
                    <a button-style="yellow" href="#" className="btn w-inline-block">
                      <div className="btn__text--parent">
                        <div className="btn__text">
                          <div className="text-sm is--btn">
                            Subscribe
                          </div>
                        </div>
                      </div>
              ...
              >
                <div className="text-lg">Thank you! Your submission has been received!</div>
              </div>
              <div
            ...
            <div
              id="w-node-_13ca7f54-c01b-761c-a9a4-eecf1f2d2ab3-1f2d2a8d"
              className="flex flex-col space-y-4"
            >
              <a href="/insights" className="footer__item w-inline-block">
                <div className="footer__item--text">
                  <div className="text-lg font-semibold">Insights</div>
                </div>
              </a>
              <a href="/category/newsroom" className="footer__item w-inline-block">
                <div className="footer__item--text">
                  <div className="text-lg font-semibold">Newsroom</div>
                </div>
              </a>
              <a href="/category/resources" className="footer__item w-inline-block">
                <div className="footer__item--text">
                  <div className="text-lg font-semibold">Resources</div>
                </div>
              </a>
              <a href="/contact" className="footer__item w-inline-block">
                <div className="footer__item--text">
                  <div className="text-lg font-semibold">Contact</div>
                </div>
              </a>
              <a href="/careers" className="footer__item w-inline-block">
                <div className="footer__item--text">
          ...
          <div className="footer__logo--parent">
            <div className="footer__logo">
              <div className="footer__logo--chars">
                <div
                  className="footer__logo--char is--s"
                  style={{
                    translate: "none",
                    rotate: "none",
                    scale: "none",
                ...
                <div
                  className="footer__logo--char is--i"
                  style={{
                    translate: "none",
                    rotate: "none",
                    scale: "none",
                ...
                <div
                  className="footer__logo--char top-space is--g"
                  style={{
                    translate: "none",
                    rotate: "none",
                    scale: "none",
                ...
                <div
                  className="footer__logo--char top-space is--n"
                  style={{
                    translate: "none",
                    rotate: "none",
                    scale: "none",
                ...
                <div
                  className="footer__logo--char is--fi"
                  style={{
                    translate: "none",
                    rotate: "none",
                    scale: "none",
                ...
                <div
                  className="footer__logo--char top-space is--c"
                  style={{
                    translate: "none",
                    rotate: "none",
                    scale: "none",
                ...
                <div
                  className="footer__logo--char top-space is--o"
                  style={{
                    translate: "none",
                    rotate: "none",
                    scale: "none",
            ...
            <div className="footer__logo--divider"></div>
          </div>
          <div className="flex justify-between">
            <div
              id="w-node-_13ca7f54-c01b-761c-a9a4-eecf1f2d2ad7-1f2d2a8d"
              className="footer__terms--list"
            >
              <a href="/privacypolicy" className="footer__terms--item w-inline-block">
                <div className="text-xs">Privacy Policy</div>
              </a>
              <a href="/terms-of-use" className="footer__terms--item w-inline-block">
                <div className="text-xs">Terms of Use</div>
              </a>
            </div>
            <div id="w-node-_13ca7f54-c01b-761c-a9a4-eecf1f2d2ae1-1f2d2a8d" className="footer__copy">
              <div className="text-xs">© <span className="year">2024</span> Significo. All rights reserved.</div>
            </div>
            <div
              id="w-node-_13ca7f54-c01b-761c-a9a4-eecf1f2d2ae7-1f2d2a8d"
              className="footer__socials"
            >
              <a
                href="https://www.instagram.com/significohealth/"
                target="_blank"
                className="footer__social--item w-inline-block"
              >
                <div className="svg w-embed">
                  <svg
                    width="100%"
              ...
              <a
                href="https://www.linkedin.com/company/significo-health/"
                target="_blank"
                className="footer__social--item w-inline-block"
              >
                <div className="svg w-embed">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M4.95312 3.2793C4.1247 3.2793 3.45312 3.95087 3.45312 4.7793V19.7793C3.45312 20.6077 4.1247 21.2793 4.95312 21.2793H19.9531C20.7815 21.2793 21.4531 20.6077 21.4531 19.7793V4.7793C21.4531 3.95087 20.7815 3.2793 19.9531 3.2793H4.95312ZM8.97388 7.28202C8.97951 8.23827 8.26373 8.82749 7.41435 8.82327C6.61419 8.81905 5.9167 8.18202 5.92092 7.28343C5.92514 6.43827 6.5931 5.75905 7.46076 5.77874C8.34107 5.79843 8.97951 6.4439 8.97388 7.28202ZM12.7328 10.0411H10.2128H10.2114V18.6009H12.8748V18.4012C12.8748 18.0213 12.8745 17.6413 12.8742 17.2612C12.8734 16.2474 12.8725 15.2325 12.8777 14.219C12.8791 13.9729 12.8903 13.717 12.9536 13.4821C13.1912 12.6046 13.9802 12.0379 14.8605 12.1772C15.4258 12.2657 15.7998 12.5934 15.9573 13.1264C16.0544 13.4596 16.098 13.8182 16.1022 14.1656C16.1136 15.2132 16.112 16.2608 16.1104 17.3085C16.1098 17.6783 16.1092 18.0483 16.1092 18.4181V18.5995H18.7811V18.3942C18.7811 17.9422 18.7809 17.4903 18.7806 17.0384C18.7801 15.9089 18.7795 14.7794 18.7825 13.6495C18.7839 13.139 18.7291 12.6356 18.6039 12.142C18.4169 11.4079 18.0302 10.8004 17.4016 10.3617C16.9558 10.0495 16.4664 9.8484 15.9194 9.8259C15.8571 9.82331 15.7943 9.81992 15.7312 9.81651C15.4515 9.80139 15.1672 9.78603 14.8998 9.83996C14.1348 9.99324 13.4627 10.3434 12.955 10.9607C12.896 11.0315 12.8383 11.1034 12.7522 11.2107L12.7328 11.235V10.0411ZM6.13477 18.6037H8.78555V10.0466H6.13477V18.6037Z"
                      fill="currentColor"
                    ></path>
                  </svg>
                </div>
              ...
              <a
                href="https://github.com/SignificoHealth"
                target="_blank"
                className="footer__social--item w-inline-block"
              >
                <div className="svg w-embed">
              ...
              <a
                href="https://www.youtube.com/@significo_"
                target="_blank"
                className="footer__social--item w-inline-block"
              >
                <div className="svg w-embed">
              ...
              <a
                href="https://www.facebook.com/significohealth"
                target="_blank"
                className="footer__social--item w-inline-block"
              >
                <div className="svg w-embed">
              ...
              <a
                href="https://twitter.com/significohealth"
                target="_blank"
                className="footer__social--item w-inline-block"
              >
                <div className="svg w-embed">
                  ...
                  >
                    <path
                      d="M17.6292 4.28027H20.3893L14.3592 11.0577L21.4531 20.2803H15.8987L11.5482 14.6869L6.57035 20.2803H3.80856L10.2583 13.0311L3.45312 4.28027H9.14857L13.081 9.39289L17.6292 4.28027ZM16.6604 18.6557H18.1899L8.31753 5.81955H6.67632L16.6604 18.6557Z"
                      fill="currentColor"
                    ></path>
                  </svg>
                </div>
